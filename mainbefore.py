...
def binary_to_image(binary_data, output_image_path):
    ...
    image.save(output_image_path, format="BMP")
    print(
...
def image_to_binary(image_path):
    ...
    binary_data = combined_bytes[4 : 4 + data_length]
...
if __name__ == "__main__":
    ...
    video_stream_path = "video_stream.h264"  # 확장자 변경
    audio_stream_path = "audio_stream.aac"  # 확장자 변경
    video_image_path = "video_compressed.bmp"
    audio_image_path = "audio_compressed.bmp"
    restored_video_stream_path = "restored_video_stream.h264"  # 확장자 변경
    restored_audio_stream_path = "restored_audio_stream.aac"  # 확장자 변경
